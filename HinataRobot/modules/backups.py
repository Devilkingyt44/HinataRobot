...
# from HinataRobot.modules.sql import warns_sql as warnssql
import HinataRobot.modules.sql.blacklist_sql as blacklistsql

# from HinataRobot.modules.sql import cust_filters_sql as filtersql
# import HinataRobot.modules.sql.welcome_sql as welcsql
import HinataRobot.modules.sql.locks_sql as locksql
import HinataRobot.modules.sql.notes_sql as sql

# from HinataRobot.modules.rules import get_rules
import HinataRobot.modules.sql.rules_sql as rulessql
from HinataRobot import EVENT_LOGS, LOGGER, OWNER_ID, SUPPORT_CHAT, dispatcher
from HinataRobot.__main__ import DATA_IMPORT
from HinataRobot.modules.connection import connected
from HinataRobot.modules.helper_funcs.alternate import typing_action
from HinataRobot.modules.helper_funcs.chat_status import user_admin
from HinataRobot.modules.sql import disable_sql as disabledsql
...
def export_data(update, context):
    ...
    with open("HinataRobot{}.backup".format(chat_id), "w") as f:
    ...
    context.bot.sendDocument(
        current_chat_id,
        document=open("HinataRobot{}.backup".format(chat_id), "rb"),
        caption="📤*Successfully Exported backup:*\nChat: `{}`\nChat ID: `{}`\nOn: `{}`\n\nNote: This `HinataRobot-Backup` was specially made for notes 📚.".format(
            chat.title, chat_id, tgl
        ),
        timeout=360,
    ...
    os.remove("HinataRobot{}.backup".format(chat_id))  # Cleaning file
