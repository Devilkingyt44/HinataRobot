...
from HinataRobot import BOT_NAME
from HinataRobot import telethn as tbot
from HinataRobot.events import register
from HinataRobot.modules.sql.night_mode_sql import (
    add_nightmode,
    get_all_chat_id,
    is_nightmode_indb,
    rmnightmode,
