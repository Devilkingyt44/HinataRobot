...
import HinataRobot.modules.sql.userinfo_sql as sql
...
from HinataRobot.__main__ import STATS, TOKEN, USER_INFO
from HinataRobot.modules.disable import DisableAbleCommandHandler
from HinataRobot.modules.helper_funcs.chat_status import sudo_plus
from HinataRobot.modules.helper_funcs.extraction import extract_user
from HinataRobot.modules.sql.global_bans_sql import is_user_gbanned
from HinataRobot.modules.sql.users_sql import get_user_num_chats
            ...
            message.reply_photo(
                ...
                reply_markup=InlineKeyboardMarkup(
                    [
                        [
                            InlineKeyboardButton(
                                "ʜᴇᴀʟᴛʜ", url="https://t.me/RajputKiDuniyaa/194"
                            ),
                            InlineKeyboardButton(
                                "ᴅɪꜱᴀꜱᴛᴇʀ", url="https://t.me/RajputKiDuniyaa/195"
                            ),
                        ],
                    ]
                ),
